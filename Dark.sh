...
figlet -f slant "DARK $red FB"             
echo
echo "$blue [»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»]"
echo "   $blue [                  $red AUTHOR : TIME EROR              $blue ]"
echo "   $blue [           $red FACEBOOK  : ?????????? ???????????     $blue ]"
echo "   $blue [            $red GITHUB : HTTPS://GITHUB.COM/TIME EROR $blue ]"
echo "   $blue [                  $red SCRIPT : BY TIME EROR           $blue ]"
echo "$blue [»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»]"
echo "$purple SILAKAN LOGIN FB "
echo
read -p "USERNAME/EMAIL : " read tr
sleep 1
read -p "PASSWORD :" read tr
echo "$yellow SEDANG MASUK..."
sleep 1
sleep 1
sleep 1
sleep 1                                                         sleep 1
...
cowsay -f ghostbusters "W E L C O M E ! ! !"|lolcat             
echo
echo "$blue [»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»]"
echo "   $blue [                  $red AUTHOR : TIME EROR              $blue ]"
echo "   $blue [           $red FACEBOOK  : ?????????? ???????????     $blue ]"
